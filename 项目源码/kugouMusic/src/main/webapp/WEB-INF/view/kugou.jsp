				...
				<div class="wrap_1">
					...
					<script type="text/javascript" src="js/Wrap.js"></script>
						...
						<div  class="wrap_1_2_3">
						 <table class="wrap_1_2_3_1" ><!--最新歌曲-->
							<c:forEach items="${song}" begin ="0" end ="5" var="wrap" varStatus="status">
								 <tr <c:if test="${status.index % 2 != 0 }"> class="wrap_1_2_3_1_1"</c:if>
									<c:if test="${status.index % 2 == 0 }">  class="wrap_1_2_3_1_2"</c:if>>
									<tr>	
								  ...
								  <div style="float: left;width: 180px;">
												<div style="float: left;width: 180px;color:#282828;font-size:12px;height: 30px;line-height: 30px;">
												${wrap.songName }</div>
					...
					<div class="hot_1_1">
						...
						<div class="hot_1_1_2">
							...
							<c:forEach items="${songHeat }" var="song" begin="0"  end="9" varStatus="status">
								<tr  <c:if test="${status.index % 2 != 0 }">class="hot_1_1_2_8"</c:if>
								<c:if test="${status.index % 2 == 0 }">class="hot_1_1_2_9"</c:if>>
									<td>
			...
			<div class="MV">
				<div class="MV_1">
					<div class="MV_1_1">
						...
						<div class="MV_1_1_2"><a href="#" title="酷狗音乐盒2013官方免费下载">
						酷狗音乐盒2013官方免费下载</a></div>
		...
		<div class="login" id="login" style="display: none;">
			...
			<script type="text/javascript">
				...
				<div class="login_3">
					...
					<div class="login_3_1">
						<label>帐号：</label>
						<input type="text" value="请输入账号名或邮箱" maxlength="15" id="loginName"
						 name="loginName" onclick="clickLogin()" onblur="mouserLogin()" />
					</div>
					<br />
					<div class="login_3_1">
						<label>密码：</label>
